...
//			e.printStackTrace();
    	...
    	try
		{
    		...
    		VOEmpresa empresa = superAndes.adicionarEmpresa("joaquin", "j@gmail.com", (long)123456, "cll 100b");
    		lista = superAndes.darClientes();
    		assertTrue(!lista.isEmpty());
    		assertTrue(lista.size()==1);
    		
    		VOPersonaNatural persona = superAndes.adicionarPersona("sebastian", "hoj@hh", (long)123);
    		lista = superAndes.darClientes();
    		assertTrue(!lista.isEmpty());
    		assertTrue(lista.size()==2);
    		
    		//Unicidad de la tabla cliente
       		VOEmpresa empresa2 = superAndes.adicionarEmpresa("sebastian", "hoj@hh", (long)123,"vbnm,");
       		assertNull("No se puede agregar la empresa",empresa2);
		}
		catch (Exception e)
		{
//			e.printStackTrace();
