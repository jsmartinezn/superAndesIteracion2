...
//			e.printStackTrace();
    	...
    	try
		{
    		List<Proveedor> lista = superAndes.darProveedores();
    		assertTrue(lista.isEmpty());
    		
    		//Se adiciona una empresa
    		VOProveedor proveedor = superAndes.adicionarProveedor((long)123, "Saltin");
    		lista = superAndes.darProveedores();
    		assertTrue(!lista.isEmpty());
    		assertTrue(lista.size()==1);
    		
    		//Unicidad de la tabla proveedores
       		VOProveedor proveedor2 = superAndes.adicionarProveedor((long)123, "Noel");
       		assertNull("No se puede agregar el proveedor",proveedor2);
